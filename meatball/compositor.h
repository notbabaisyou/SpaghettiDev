...
extern void XLFrameClockAfterFrame(FrameClock *, void (*)(FrameClock *, void *, uint64_t),
                                   void *);
...
extern void XLFrameClockSetFreezeCallback(FrameClock *, void (*)(void *, Bool),
                                          Bool (*)(void *), void *);
...
/**
 * Previously `TimerCheck`, renamed to avoid
 * conflict with the X.Org ABI.
 */
...
extern Bool OwnSelection(Timestamp, Atom, GetDataFunc (*)(WriteTransfer *, Atom, Atom *),
                         Atom *, int);
...
extern void SyncHelperSetResizeCallback(SyncHelper *, void (*)(void *, Bool),
                                        Bool (*)(void *));
