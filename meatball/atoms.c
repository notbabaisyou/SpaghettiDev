...
Atom _XL_BUFFER_RELEASE;
Atom _NET_WM_SYNC_REQUEST_COUNTER;
Atom _NET_WM_FRAME_DRAWN;
...
Atom _XL_DMA_BUF_CREATED;
Atom _GTK_SHOW_WINDOW_MENU;
...
Atom libinput_Scroll_Methods_Available;
Atom XdndAware;
Atom XdndSelection;
Atom XdndTypeList;
Atom XdndActionCopy;
...
Atom _NET_WM_PID;
Atom _NET_WM_PING;
Atom libinput_Scrolling_Pixel_Distance;
...
void ProvideAtom(const char *name, Atom atom)
{
	unsigned int hash;
	ptrdiff_t bucket_length, i;
