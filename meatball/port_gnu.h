...
#define _GL_INT_ADD_RANGE_OVERFLOW(a, b, tmin, tmax)                                                           \
	((b) < 0                                                                                                   \
		 ? (((tmin)                                                                                            \
				 ? ((_GL_EXPR_SIGNED(_GL_INT_CONVERT(a, (tmin) - (b))) || (b) < (tmin)) && (a) < (tmin) - (b)) \
				 : (a) <= -1 - (b)) ||                                                                         \
			((_GL_EXPR_SIGNED(a) ? 0 <= (a) : (tmax) < (a)) && (tmax) < (a) + (b)))                            \
	 : (a) < 0                                                                                                 \
		 ? (((tmin)                                                                                            \
				 ? ((_GL_EXPR_SIGNED(_GL_INT_CONVERT(b, (tmin) - (a))) || (a) < (tmin)) && (b) < (tmin) - (a)) \
				 : (b) <= -1 - (a)) ||                                                                         \
			((_GL_EXPR_SIGNED(_GL_INT_CONVERT(a, b)) || (tmax) < (b)) && (tmax) < (a) + (b)))                  \
		 : (tmax) < (b) || (tmax) - (b) < (a))
#define _GL_INT_SUBTRACT_RANGE_OVERFLOW(a, b, tmin, tmax)                                                   \
	(((a) < 0) == ((b) < 0)                                                                                 \
		 ? ((a) < (b)                                                                                       \
				...
				: (tmax) < (a) - (b))                                                                       \
	 : (a) < 0                                                                                              \
		 ? ((!_GL_EXPR_SIGNED(_GL_INT_CONVERT((a) - (tmin), b)) && (a) - (tmin) < 0) || (a) - (tmin) < (b)) \
		 : ((!(_GL_EXPR_SIGNED(_GL_INT_CONVERT(tmax, b)) && _GL_EXPR_SIGNED(_GL_INT_CONVERT((tmax) + (b), a))) && (tmax) <= -1 - (b)) || (tmax) + (b) < (a)))
...
#define _GL_INT_OP_WRAPV(a, b, r, op, overflow)                                                 \
	(_Generic(*(r),                                                                             \
		 signed char: _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int,                      \
									  signed char, SCHAR_MIN, SCHAR_MAX),                       \
		 unsigned char: _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int,                    \
										unsigned char, 0, UCHAR_MAX),                           \
		 short int: _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int,                        \
									short int, SHRT_MIN, SHRT_MAX),                             \
		 unsigned short int: _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int,               \
											 unsigned short int, 0, USHRT_MAX),                 \
		 int: _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int,                              \
							  int, INT_MIN, INT_MAX),                                           \
		 unsigned int: _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned int,                     \
									   unsigned int, 0, UINT_MAX),                              \
		 long int: _GL_INT_OP_CALC(a, b, r, op, overflow, unsigned long int,                    \
